...
<div class="mt-2 max-w-sm rounded overflow-hidden shadow-lg">
  ...
  <button class=' text-black mt-1 inline-flex cursor-pointer items-center text-sm font-semibold'>{btnText}</button>
</div>
    )
}
